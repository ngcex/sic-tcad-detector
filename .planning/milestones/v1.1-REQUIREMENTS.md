...
**Defined:** 2026-03-23
**Core Value:** Explore how CCE in 4H-SiC detectors behaves under FLASH dose rates as a TCAD sensitivity study. (Note: the original "first TCAD-based explanation of plasma recombination" framing is NOT supported by the implemented physics — see `.planning/PHYSICS_AUDIT_v5.md` C-3; outputs are exploratory bounds, not a validated mechanistic prediction.)
