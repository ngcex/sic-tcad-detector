...
| -------- | ---- | ---- | -------------- | ---------- | --------------- | ----------- | ----------------------------------------------------------------------------------- | -------------- | ---------- |
| 35-01-01 | 01   | 1    | PKG-01, PKG-02 | —          | N/A             | smoke       | `uv pip install -e . && python -c "from petringa import DeviceConfig; print('OK')"` | ❌ Wave 0      | ⬜ pending |
...
2. `python -c "from petringa import DeviceConfig"` exits 0
3. `python -c "from petringa.core.device import create_sic_device"` exits 0
