# Requirements Archive: v1.0 SiC TCAD Simulator MVP
...
**Defined:** 2026-03-20
**Core Value:** Explore how charge collection efficiency in 4H-SiC detectors behaves under FLASH dose rates as a TCAD sensitivity study. (Note: the original "first TCAD-based explanation of plasma recombination" framing is NOT supported by the implemented physics — see `.planning/PHYSICS_AUDIT_v5.md` C-3; outputs are exploratory bounds, not a validated mechanistic prediction.)
...
- [x] **CCE-04**: Model radiation generation profile from proton Bragg peak energy deposition (30, 70, 150 MeV configurations from etna experiments)
