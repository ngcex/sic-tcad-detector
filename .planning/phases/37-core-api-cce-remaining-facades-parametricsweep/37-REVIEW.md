...
**File:** `etna/api/simulation.py:810-863` (specifically line 862)
...
**File:** `etna/api/simulation.py:414-807` (all 6 Plan-02 facades), `etna/api/sweep.py:70-81`
...
**File:** `etna/api/simulation.py:846-847`
...
**File:** `tests/test_api_facades.py`, `etna/api/simulation.py:414-807`
