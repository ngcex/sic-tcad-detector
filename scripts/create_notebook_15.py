"""Script to create notebook 15_2d_electrostatics_cce.ipynb programmatically."""
...
cells.append(new_markdown_cell("### Center-slice comparison plots"))
...
cells.append(new_markdown_cell("### Lateral scan for 300 um SV (half-width = 150 um)"))
...
cells.append(new_markdown_cell("### CCE lateral profile comparison"))
...
cells.append(new_markdown_cell("### Full-device CCE heatmap (mirrored about x = 0)"))
...
cells.append(new_markdown_cell("### Summary table: 2D vs 1D CCE"))
