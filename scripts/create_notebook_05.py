...
nb.cells.append(
    nbformat.v4.new_code_cell(
        ...
        "from petringa.core.flash_recombination import (parametric_cce_sweep, save_parametric_results,\n"
        "                                      load_parametric_results, cce_vs_dose_rate)\n"
        "from petringa.core.plotting import (plot_parametric_epi, plot_parametric_doping, plot_parametric_bias,\n"
