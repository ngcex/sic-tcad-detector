...
| --------------------- | ---- | ---- | -------------- | ----------------------- | ---------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ----------- | -------------------------------------------------------------------- |
| 36-01-01              | 01   | 1    | LIB-01         | —                       | N/A                                      | unit                                         | `python -c "from etna.api.results import SimResult, MeshData; ..."` (field-order assert)                                   | ✅          | ✅ green                                                             |
...
| 36-01-03              | 01   | 1    | LIB-01         | —                       | N/A                                      | unit                                         | `python -c "from etna import DeviceConfig, SimResult, MeshData, __version__; ..."`                                         | ✅          | ✅ green                                                             |
...
| 36-03-02              | 03   | 3    | LIB-03         | —                       | N/A                                      | unit                                         | `python -c "from etna import DeviceConfig, SimResult, MeshData, run_cv, run_field; ..."`                                   | ✅          | ✅ green                                                             |
