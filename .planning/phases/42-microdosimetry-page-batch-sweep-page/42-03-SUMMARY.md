...
- **Verification:** `uv run --extra dev pytest tests/test_app_batch_sweep_page.py -q` → 6 passed; combined run with `test_app_dark_current_page.py` + `test_app_csv_export.py` → 20 passed (no regression).
